...
module Statusable::HasStatuses
  ...
  class_methods do
    ...
    def has_statuses(
      ...
      # .humanized_statuses_list
      define_singleton_method("humanized_#{col_name.to_s.pluralize}_list") do
        humanized_statuses_list.freeze
      end

      # Instance method to get a humanized list of statuses.
      # #humanized_statuses_list
      define_method("humanized_#{col_name.to_s.pluralize}_list") do
        humanized_statuses_list.freeze
      end
